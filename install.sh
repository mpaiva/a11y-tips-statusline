...
echo ""
echo "Tips rotate every 30 seconds and word-wrap to fit your terminal width"
echo "so the full guideline text is always visible."
echo ""
...
echo "  /wcag level:A focus - combined level filter + keyword"
echo ""
echo "To uninstall:"
